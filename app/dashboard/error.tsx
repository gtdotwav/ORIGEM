...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 text-center">
      <div className="rounded-2xl border border-red-500/20 bg-red-500/5 px-8 py-6 backdrop-blur-xl">
        <h2 className="text-lg font-semibold text-foreground/90">
          Erro na pagina
        </h2>
        <p className="mt-2 max-w-md text-sm text-foreground/55">
          Esta pagina encontrou um problema. Suas sessoes e dados estao salvos.
        </p>
